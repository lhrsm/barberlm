-- 1. Update cancel_appointment RPC to use more descriptive status names
...
AS $function$
 ...
 BEGIN
     ...
     -- 5. Automatic reversal of Credits/Cashback
     -- (Logic for credits/cashback reversal should be here or in a separate function)
     -- We assume it's handled or we'll add it if missing, but focusing on the requested fix.
     ...
     IF v_is_pix_paid AND p_refund_preference = 'credits' THEN
         INSERT INTO public.customer_credits (
             ...
             p_appointment_id,
             v_pix_amount,
             'Cancelamento de agendamento pago',
             'credit'
