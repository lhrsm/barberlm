...
export function processAutomationTemplate(template: string, data: Record<string, any>): string {
  ...
  const variables: Record<string, any> = {
    ...
    previous_date: data.previous_date || data.old_date || "",
    previous_time: data.previous_time || data.old_time || "",
    new_date: data.new_date || data.appointment_date || "",
    new_time: data.new_time || data.appointment_time || "",
    previous_professional_id: data.previous_professional_id || data.previous_barber_id || "",
    previous_professional_name: data.previous_professional_name || data.old_professional_name || "",
    previous_professional_phone: data.previous_professional_phone || "",
    old_professional_name: data.old_professional_name || data.previous_professional_name || "",
    new_professional_id: data.new_professional_id || data.new_barber_id || "",
    new_professional_name: data.new_professional_name || "",
    new_professional_phone: data.new_professional_phone || "",
    actor_id: data.actor_id || "",
    actor_type: data.actor_type || "",
    actor_name: data.actor_name || "",
    actor_label: data.actor_label || "",
    customer_management_link: data.customer_management_link || "",
    new_professional_management_link: data.new_professional_management_link || "",
    internal_management_link: data.internal_management_link || "",
