...
import { Zap, TrendingUp, Target, AlertCircle, Sparkles, ArrowRight, ShieldCheck, BrainCircuit, Loader2 } from "lucide-react";
...
export function MarketingAIAdvisor({ tenantId }) {
    ...
    return (<div className="space-y-4">
      ...
      <div className="grid gap-3">
        ...
        {(!recommendations || recommendations.length === 0) && (<div className="text-center py-8 rounded-2xl border border-dashed border-white/10">
