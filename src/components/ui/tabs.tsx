...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center gap-1 overflow-x-auto rounded-xl border border-border/50 bg-surface-sunken p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
