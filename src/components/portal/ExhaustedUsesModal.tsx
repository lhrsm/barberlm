      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={cn(
            ...
            "rounded-2xl overflow-hidden border-2 border-[#D4AF37]/50",
        ...
        >
          ...
          <div className="relative p-6">
            ...
            <div className="mt-4 rounded-xl border border-[#D4AF37]/25 bg-black/40 p-4 space-y-2">
              {planName && (
              ...
              {usedLabel && (
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-[#D4AF37] font-black">{usedLabel}</span>
                </div>
              )}
              {renewalDate && (
                <div className="flex items-center justify-between text-xs">
            ...
            <div className="mt-5 grid gap-2.5">
              <button
                ...
                className="h-12 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#F5D061] text-black font-black uppercase tracking-wider text-sm flex items-center justify-center gap-2 shadow-[0_8px_24px_rgba(212,175,55,0.35)] hover:brightness-110 hover:-translate-y-0.5 transition-all"
              >
