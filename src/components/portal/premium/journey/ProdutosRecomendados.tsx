  ...
  return (
    ...
    >
      <div className="mb-4 flex items-end justify-between gap-3">
        <div>
          <p className="text-[10px] uppercase tracking-[0.3em] font-black text-gold">Curadoria Barbex</p>
          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                "text-left backdrop-blur transition-all hover:-translate-y-0.5 hover:border-gold/45",
            ...
            >
              <div className="relative aspect-square bg-gradient-to-br from-white/5 to-transparent">
                ...
                <div className="absolute top-2 left-2 flex items-center gap-1 px-2 py-1 rounded-full bg-black/60 backdrop-blur text-[9px] font-black uppercase tracking-widest text-gold border border-gold/40">
              ...
              <div className="p-3">
                ...
                <div className="mt-2 flex items-center justify-between">
                  <p className="text-base font-black text-gold">R$ {price.toFixed(2)}</p>
