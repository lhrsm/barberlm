  ...
  async function testConnection() {
    ...
    try {
      ...
      if (data.connected === true) {
        ...
        // 2. Automatically try to send a test message as requested
        toast.info("Enviando mensagem de teste...");
        await sendTestMessage();
        
      } else {
        console.log("[Z-API Test] Disconnected result:", data);
        toast.error("WhatsApp desconectado na Z-API (connected: false).");
      }
        ...
        <CardHeader className="pb-4">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <CardTitle className="text-xl font-bold tracking-tight">WhatsApp Principal</CardTitle>
            ...
            <div className="space-y-4 pt-6 border-t border-white/10 flex flex-col items-center justify-center text-center">
              <div className="bg-red-500/10 p-6 rounded-2xl border border-red-500/20 max-w-md">
                ...
                <p className="text-sm text-slate-400">
                  Sua instância Z-API está desconectada. Por favor, acesse o painel da Z-API, escaneie o QR Code lá e depois clique em <strong>"Testar Status"</strong> aqui.
                </p>
                <Button 
                  variant="outline" 
                  size="sm" 
