    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#050b18] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="mb-8 flex flex-col items-center">
          <img src="/__l5e/assets-v1/09902c18-ce15-4559-987e-73b6866a0457/logo-barbex.png" alt="Barbex Logo" className="w-[120px] md:w-[150px] object-contain block mx-auto" />
